...
exports.AppDataSource = new typeorm_1.DataSource({
    ...
    synchronize: true,
    logging: false,
    entities: [Part_1.Part, Project_1.Project, User_1.User, Compound_1.Compound, LogEntry_1.LogEntry, PartCombine_1.PartCombine, Server_1.Server, CompoundPart_1.CompoundPart],
    subscribers: [],
    migrations: [],
});
